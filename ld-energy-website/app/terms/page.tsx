...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <p>
        Improvement Plan documents are prepared after the visit and sent within 72 hours of the assessment. A Pre-Assessment is not lodged and produces no certificate, so no lodgement timescale and no next-day option apply to it; its Energy Report and written plan are sent within 72 hours of the visit.
      </p>

      <h2>5. EPC Pre-Assessment</h2>
      <p>
        A Pre-Assessment is a full survey carried out to the same standard as an EPC assessment, which we deliberately do not lodge. <strong>It is not an Energy Performance Certificate</strong> and must not be relied on where an EPC is legally required, including marketing a property for sale or rent and demonstrating compliance with the Minimum Energy Efficiency Standard (MEES) as a landlord. It confers none of the legal effect of a lodged certificate.
      </p>
      <p>
